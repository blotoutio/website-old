---
meta:
  title: How Lux increased conversion event visibility by 167% | Blotout
...
<a href='https://luxcando.com' target='_blank'>LUX Foundation Solutions</a> specializes in engineering and structural in the residential and commercial building
markets. They use a sophisticated marketing mix of SEO and lead generation campaigns
across a variety of channels in order to increase brand awareness and drive top of
funnel activity. They have traditionally relied on Google Analytics to assess their
site engagement and conversion metrics, with conversions consisting of leads converting
to phone calls and email exchanges with its sales organization.
...
![image](/img/case-studies/lux-foundation-solutions/lux-year.png)
...
![image](/img/case-studies/lux-foundation-solutions/lux-blocked.png)
...
![image](/img/case-studies/lux-foundation-solutions/lux-blotout.png)

## Side-by-Side Results – Google Analytics vs Blotout:

**7-day view with Google Analytics:**
![image](/img/case-studies/lux-foundation-solutions/lux-7-day-g.png)

**7-day view with Blotout:**
![image](/img/case-studies/lux-foundation-solutions/lux-7-day-b.png)
