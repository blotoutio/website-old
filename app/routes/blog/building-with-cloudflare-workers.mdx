...
![Building the future with Cloudflare Workers](/img/blog/building-with-cloudflare-workers/cloudflare-workers.png)
...
**Our first product built with Cloudflare Workers—[Blotout EdgeTag](https://edgetag.io/facebook-conversion-api)—leverages these capabilities to let you send data to the Facebook Conversion API directly from your domain. It requires only two minutes to set up and [increases leads by ~30%](https://blotout.io/case-studies/edgetag-facebook-lux). This is a huge win for customers who have struggled to enable pixels after changes to iOS and Firefox.**
