...
## Here are some results from our first launch.

### Case Study 1: Shopify Merchant

**Profile; **

A Shopify merchant making 500-1,000 sales a day with an average price point of $50. Implemented Shopify client pixel and Server CAPI available for Shopify merchants.
...
Well known adventure retail company providing retail experiences looking to improve their ROI on Facebook spend. Enterprise had not yet mapped their online and offline identity or implemented the Server Side CAPI.
...
Go to [edgetag.io](https://edgetag.io/), sign up and self-serve by implementing your CAPI as a Java Tag. For customers who are doing more than 10M events per day, email us at edgetag@blotout.io
