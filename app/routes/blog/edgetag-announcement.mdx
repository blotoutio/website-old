...
meta:
  ...
  og:image: 'https://blotout.io/img/blog/edgetag-announcement.png'
data:
  date: '2021-12-07'
---
...
![Blotout EdgeTag: Fix your Facebook Pixels in 2 min](/img/blog/edgetag-announcement.png)
...
To take it for a spin, head to <a href='https://edgetag.io/facebook-conversion-api' target='_blank' rel='next' onClick={() => codifyClick('EdgeTag Announcement Blog - EdgeTag Website')}>edgetag.io/facebook-conversion-api</a> and get set up in only 2 minutes. Our [Cloudflare app](https://cloudflare.com/apps) for the same will be released by Dec 7, 2021.
...
![Use of ad blockers by country (HootSuite, 2021)](/img/blog/edgetag-announcement-1.png)
...
![Google’s server tag container — expensive and cumbersome](/img/blog/edgetag-announcement-2.png)
<span className='caption'>**Figure**: Google’s server tag container — expensive and cumbersome</span>

![Facebook’s AWS Gateway for its Conversions API (CAPI)](/img/blog/edgetag-announcement-3.png)
