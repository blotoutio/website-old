...
<MDX>
  <div className="blog-header">
    <h1>Privacy by trust vs. Privacy by design</h1>
    <span className="date">December 14, 2019</span>
  </div>
