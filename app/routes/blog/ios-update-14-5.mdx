...
<div className='right'>
  <img src='/img/blog/ios-update-14-5/ios-145-ask.png' alt='A screenshot of an iPhone app asking for permission to track the user across other companies’ apps and websites to deliver personalized ads' />
</div>
...
<div className='right'>
  <img src='/img/blog/ios-update-14-5/ios-145-how.png' alt='A screenshot of an iPhone app’s details page in the App Store displaying information about the kinds of data that app will use to track and link the user across other companies’ apps and websites' />
</div>
