...
<div className='right'>
  <img src='/img/blog/storybook-1.png' alt='A grid of different monochrome icons like checkmark, clock, funnel, dots, star, etc' />
</div>

**Example**: We manage different states for dropdowns in Storybook.

<div className='right'>
  <img src='/img/blog/storybook-2.gif' alt='A screenshot of the Storybook dashboard with an open ‘Canvas’ panel on the left and an open ‘Controls’ panel displaying multiple dropdown states on the right' />
</div>

**Example**: We are able to explore button properties for new UI contexts.

<div className='right'>
  <img src='/img/blog/storybook-3.gif' alt='A GIF, i.e. an animated image, showing the ‘Controls’ panel in the Storybook dashboard can be used to test different states of the button component' />
</div>
