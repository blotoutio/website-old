...
<div className='right'>
  <img src='/img/blog/open-ai.jpg' alt='A stylised illustration of a Robot holding a sphere with the words ‘AI’ written inside alongwith the OpenAI logo and the text ‘OpenAI GPT-3’ below it' />
</div>
