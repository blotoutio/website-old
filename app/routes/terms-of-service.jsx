  ...
  return (
    <div id='terms-of-service' className='legal'>
      <div id='terms-of-service-header' className='legal-header'>
        <div
          id='terms-of-service-header-content'
      ...
      <div id='terms-of-service-text' className='legal-text'>
        <div id='terms-of-service-text-content' className='legal-text-content'>
          ...
          <p>
            By agreeing to the Terms of Service, Blotout, Inc grants the Client
            a limited, non-exclusive, non-transferable right to the SDK, and SDK
            Services governed by the Terms of Service.
          </p>
          <p>
          ...
          <p>
            ...
            the SDK and is solely responsible for their access according to the
            Terms of Service.
          </p>
          <p>
          ...
          <p>
            The SDK is billed on a subscription basis (“Subscription(s)”) based
            on the agreement signed between Blotout, Inc and the Client’s (the
            “Contract”)
          </p>
          <p>
            Your Subscription(s) to the SDK is based on the Contract that you
            may have signed with Blotout, Inc. The Contract decides the terms of
            your payment and limits the user of SDK per terms in the Contract.
            The Contract dictates if your services are to be continued or
            discontinued per these terms.
          </p>
          <p>
            Blotout, Inc has the right to change the subscription fees set forth
            in the Contract at any time during the term of the Contract via a
            written notice to the client authorized account.
          </p>
          <p>
            <span>Refunds</span>
          </p>
          <p>
            ...
            present, the Terms of Service provides no provision for a refund of
            fees.
          </p>
          <p>
          ...
          <p>
            ...
            us information that is accurate, complete, and current at all times.
          ...
          <p>
            You are responsible for the usernames and passwords registered with
            the SDK. You may not choose to use usernames that may infringe a
            trademark or copyright or otherwise offensive, obscene, or vulgar.
          </p>
          <p>
          ...
          <p>
            The SDK and its original content, features and functionality are and
            will remain the exclusive property of Blotout, Inc. The SDK is
            protected by copyright, trademark, and other laws of the United
            States and other foreign nations. Our trademarks may not be used in
            connection with any product or service without the prior written
            consent of Blotout, Inc
          </p>
          <p>
          ...
          <p>
            Upon termination, your right to use the SDK will immediately cease.
            If you wish to terminate your account, you may simply discontinue
            using the SDK and inform Blotout, Inc with a written notice of
            termination. You will be continued to be charged per the Contract.
          </p>
          <p>
          ...
          <p>
            ...
            to or use of or inability to access or use the SDK; (ii) any conduct
            or content of any third party on the SDK; (iii) any content obtained
            from the SDK; and (iv) unauthorized access, use or alteration of
          ...
          <p>
            Your use of the SDK is at your sole risk. The SDK is provided on an
            “AS IS” and “AS AVAILABLE” basis via a Blotout, Inc hosted location.
            The SDK is provided without warranties of any kind, whether express
            or implied, including, but not limited to, implied warranties of
            merchantability, fitness for a particular purpose, non-infringement
            or course of performance.
          </p>
          <p>
            Blotout, Inc, its subsidiaries, affiliates, and its licensors do not
            warrant that a) the SDK will function uninterrupted, secure or
          ...
          <p>
            ...
            do not agree to the new terms, please stop using the SDK.
          </p>
          <p>
            <span>Contact</span>
          </p>
